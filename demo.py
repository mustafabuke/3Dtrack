...
def main(args):
    ...
    print("FPS : " , frame_id/passed_time)
    print(frame_id)
...
parser.add_argument('--video', type=str, default = "demo/record1/mbuke_record1_30fps.mp4", help='video file name')
...
parser.add_argument('--cdt', type=float, default=100.0, help='coasted deletion time')

...
if __name__ == "__main__":
    ...
    parser.add_argument('--img', default="~/home/mustafabuke/PycharmProjects/UCMCTrack-master/demo/00000001 (1).jpg",type=str, required= True,help='The image file ')
    parser.add_argument('--cam_para', default="~/home/mustafabuke/PycharmProjects/UCMCTrack-master/cam_para/DanceTrack/dancetrack0038.txt",type=str, required= True,help='The estimated camera parameters file ')
